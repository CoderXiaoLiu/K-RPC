...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Krpcheader_2eproto = {
  false, false, 107, descriptor_table_protodef_Krpcheader_2eproto, "Krpcheader.proto", 
  ...
  file_level_metadata_Krpcheader_2eproto, file_level_enum_descriptors_Krpcheader_2eproto, file_level_service_descriptors_Krpcheader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_Krpcheader_2eproto_getter() {
  return &descriptor_table_Krpcheader_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_Krpcheader_2eproto(&descriptor_table_Krpcheader_2eproto);
namespace Krpc {
